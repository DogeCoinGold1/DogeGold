Dogegold Core version 1.14.3 is now available from:

  <https://github.com/dogegold/dogegold/releases/tag/v1.14.3/>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/dogegold/dogegold/issues>

To receive security and update notifications, please watch reddit or Twitter:

  * https://www.reddit.com/r/dogegold/
  * @Dogegold on Twitter for high priority announcements
  * @dogegold\_devs on Twitter for updates on development work
...
Dogegold Core is extensively tested on Ubuntu Server LTS, Mac OS X and Windows 10.
...
Dogegold Core should also work on most other Unix-like systems but is not
...
Block download timeouts are expressed as a multiple of block interval, and as such Dogegold block download times were relatively aggressive, leading to a high number of timeouts. Increased the timeouts to be more flexible to real world conditions.
...
* Return unspents greater or equal than a specific amount in DOGEG: minimumAmount (default = 0).
* Return unspents lower or equal than a specific amount in DOGEG: maximumAmount (default=unlimited).
* Return unspents with a total number lower or equal than a specific number: maximumCount (default=0=unlimited).
* Return unspents which total is greater or equal than a specific amount in DOGEG: minimumSumAmount (default=unlimited).
...
* Change IPC prefix from `bitcoin:` to `dogegold:`.
