...
- ThreadSocketHandler : Sends/Receives data from peers on port 13131.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 33111 for connections and services them.

- DogegoldMiner : Generates dogegolds (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:dogegold/dogegold.git
