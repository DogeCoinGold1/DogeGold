...
bool AllowMinDifficultyForBlock(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    // Dogegold: Magic number at which reset protocol switches
...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    // Dogegold: Special rules for minimum difficulty blocks with Digishield
    ...
    bool fNewDifficultyProtocol = (pindexLast->nHeight >= 1);
    ...
    return CalculateDogegoldNextWorkRequired(pindexLast, pindexFirst->GetBlockTime(), params);
}
