...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dogegold-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dogegold-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dogegold transaction") + "\n" +
              "  dogegold-tx [options] -create [commands]   " + _("Create hex-encoded dogegold transaction") + "\n" +
              "\n";
